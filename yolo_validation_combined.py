...
def main():
    ...
    try:
        full_partial_auc = roc_auc_score(y_true, y_scores)
        print(f"Full Partial AUC (FPR <= 0.1): {full_partial_auc:.4f}")
    except ValueError as e:
        print(f"Could not compute full partial AUC: {e}")
