...
if __name__ == "__main__":
    ...
    ds = read_dicom("series/1.2.826.0.1.3680043.8.498.10005158603912009425635473100344077317/1.2.826.0.1.3680043.8.498.10775329348174902199350466348663848346.dcm")
    plot_dicom(ds)