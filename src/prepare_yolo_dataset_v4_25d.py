...
#Example: python3 -m src.prepare_yolo_dataset_v4_25d --generate-all-folds --out-name yolo_dataset --img-size 512 --label-scheme locations --yaml-out-dir configs --yaml-name-template yolo_fold{fold}.yaml --overwrite

#RGB mode (3-channel from adjacent slices):
#Example: python3 -m src.prepare_yolo_dataset_v4_25d --generate-all-folds --out-name yolo_dataset_rgb --img-size 512 --label-scheme locations --rgb-mode --yaml-out-dir configs --yaml-name-template yolo_fold{fold}.yaml --overwrite
