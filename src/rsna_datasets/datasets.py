...
class NpzDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str = None):
        ...
        self.train_dataset = NpzVolumeDepthSliceDataset(uids=list(train_uids), cfg=self.cfg,
                                                        transform=self.train_transforms)
        self.val_dataset = NpzVolumeDepthSliceDataset(uids=list(val_uids), cfg=self.cfg, transform=self.val_transforms,
                                                      mode="val")
