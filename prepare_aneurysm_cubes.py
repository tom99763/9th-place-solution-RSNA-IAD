...
def parse_args():
    ...
    ap.add_argument("--output-dir", default="aneurysm_cubes", help="Output directory")
    ap.add_argument("--cube-shape", nargs=3, type=int, default=[32, 128, 128], 
                    help="Cube dimensions as D H W (default: 32 128 128)")
    ap.add_argument("--max-positive", type=int, default=4000, help="Max positive samples to process")
    ap.add_argument("--max-negative", type=int, default=4000, help="Max negative samples to process")
