...
def train(cfg: DictConfig) -> None:
    ...
    for fold_id_yolo in range(2):
        for fold_id in range(5):
            ...
            cfg_fold.fold_id_yolo = fold_id_yolo

            wnb_logger = WandbLogger(
                project=cfg_fold.project_name,
                name=f"{cfg_fold.experiment}_fold{fold_id}_fold_id_yolo={fold_id_yolo}",
